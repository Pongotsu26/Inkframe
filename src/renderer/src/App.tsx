...
const DEFAULT_OPTIONS: ConvertOptions = { theme: "github", codeTheme: DEFAULT_CODE_THEME, paper: "A4", margin: "18mm", orientation: "portrait", toc: false, pageNumber: true, cover: false, font: {} };
