...
contextBridge.exposeInMainWorld("mdpdf", {
  ...
  createTheme: (name, sourceTheme) => ipcRenderer.invoke("themes:create", name, sourceTheme),
  ...
  setDefaultTheme: theme => ipcRenderer.invoke("settings:set-default-theme", theme),
